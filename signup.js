import { View,TouchableOpacity, Text,SafeAreaView, Image, useWindowDimensions, KeyboardAvoidingView, ScrollView, ActivityIndicator, } from "react-native";
    ...
    <SafeAreaView style={styles.container}>
        <ScrollView>
            <KeyboardAvoidingView  style={{width: width, alignItems: 'center'}}>
                ...
                <SecondaryBtn name='Already have an account? Click here' onPress={signin} />
